...
function openNewTab28() {
  const url = 'https://integratedmanagementstrategies.com/';
  window.open(url, '_blank');
}

function openNewTab29() {
  const url = 'https://kzootms.com/';
  window.open(url, '_blank');
}

function openNewTab30() {
  const url = 'https://albasateen.sa/';
  window.open(url, '_blank');
}

function openNewTab31() {
  const url = 'https://dika.edu.my/';
  window.open(url, '_blank');
}

function openNewTab32() {
  const url = 'https://talento.com.my/';
  window.open(url, '_blank');
}

function openNewTab33() {
  const url = 'https://marinerokl.my/';
  window.open(url, '_blank');
}

function openNewTab34() {
  const url = 'https://theschoolhouse.com.sg/';
  window.open(url, '_blank');
}

function openNewTab35() {
  const url = 'https://smallwonderpreschool.com/';
  window.open(url, '_blank');
}

function openNewTab36() {
  const url = 'https://kingsley.edu.my/kis';
  window.open(url, '_blank');
}

function openNewTab37() {
  const url = 'https://edternal.com/';
  window.open(url, '_blank');
}

function openNewTab38() {
  const url = 'https://wmsandor.com/';
  window.open(url, '_blank');
}

function openNewTab39() {
  const url = 'https://perpetualcare.com.my/';
  window.open(url, '_blank');
}

function openNewTab40() {
  const url = 'https://acc-group.com.my/';
  window.open(url, '_blank');
}

function openNewTab41() {
  const url = 'https://sarahtareenofficial.com/';
  window.open(url, '_blank');
}
